...
Desenvolveremos um sistema de \define{dedução natural}. Para cada conectivo, haverá regras de \define{introdução}, que nos permitirão provar uma sentença que tenha esse conectivo como operador lógico principal, e regras de \define{eliminação}, que nos permitirão provar algo a partir de uma sentença que tenha esse conectivo como operador lógico principal.
