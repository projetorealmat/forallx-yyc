...
\stepcounter{chapter} % Introdução à LM
...
\problempart
Forneça demonstrações para todas as seguintes:
\begin{compactlist}
...
\problempart
Forneça demonstrações para os seguintes (sem usar conversão modal!):
\begin{compactlist}
...
\problempart
Forneça demonstrações dos seguintes (agora você pode usar conversão modal!):
\begin{compactlist}
...
\problempart
Forneça demonstrações para os seguintes:
\begin{compactlist}
...
Apresentamos todas as contra-interpretações diagramaticamente. Se preferir escrevê-las explicitamente, tudo bem também!

\setcounter{ProbPart}{0}

\problempart
Apresente contra-interpretações para as seguintes:
\begin{compactlist}
...
\end{tikzpicture}
\bmlDescription{O mundo 1 está conectado por uma seta ao mundo 2. O mundo 1 está rotulado com não-P e o mundo 2 com P.}
\end{center}
}
...
\end{tikzpicture}
\bmlDescription{O mundo 1 está conectado por setas a si mesmo e ao mundo 2. O mundo 1 está rotulado com P e não-Q. O mundo 2 está rotulado com não-P e Q.}
\end{center}
}
...
\end{tikzpicture}
\bmlDescription{O mundo 1 é o único mundo e não está conectado a si mesmo. Ele está rotulado com não-A.}
\end{center}
}
...
\draw (2.4,-0.6) rectangle (3.6,0.5);
\end{tikzpicture}
\bmlDescription{O mundo 1 está conectado por uma seta ao mundo 2. O mundo 1 está rotulado com não-A. O mundo 2 está rotulado com A.}
\end{center}
}
\end{compactlist}
...
\draw (2.4,-1.2) rectangle (3.6,0.5);
\end{tikzpicture}
\bmlDescription{O mundo 1 está conectado ao mundo 2 por uma seta. Ambos os mundos estão conectados a si mesmos por uma seta. O mundo 1 está rotulado com não-M e não-O. O mundo 2 está rotulado com M e O.}
\end{center}
}
...
\end{tikzpicture}
\bmlDescription{O mundo 1 está conectado por uma seta ao mundo 2, e o mundo 2 por uma seta ao mundo 3. Cada mundo está conectado a si mesmo por uma seta. Os mundos 1 e 2 estão rotulados com A. O mundo 3 está rotulado com não-A.}
\end{center}
}
\end{compactlist}
...
\draw (2.4,-0.6) rectangle (3.6,0.5);
\end{tikzpicture}
\bmlDescription{O mundo 1 está conectado ao mundo 2 por uma seta. Ambos os mundos estão conectados a si mesmos por uma seta. O mundo 1 está rotulado com A. O mundo 2 está rotulado com não-A.}
\end{center}
}
...
\draw (2.4,-1.2) rectangle (3.6,0.5);
\end{tikzpicture}
\bmlDescription{O mundo 1 está conectado ao mundo 2 por uma seta. Ambos os mundos estão conectados a si mesmos por uma seta. O mundo 1 está rotulado com A e B. O mundo 2 está rotulado com não-A e não-B.}
\end{center}
}
\end{compactlist}
