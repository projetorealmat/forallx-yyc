...
\end{tikzpicture}
\bmlDescription{World 1 is connected by an arrow to world 2. World 1
is labelled by not-P and world 2 by P.}
\end{center}
}
...
\end{tikzpicture}
\bmlDescription{World 1 is connected by arrows to itself and to world
2. World 1 is labelled P and not-Q. World 2 is labelled not-P and Q.}
\end{center}
}
...
\end{tikzpicture}
\bmlDescription{World 1 is the only world, and not connected to
itself. It is labelled not-A.}
\end{center}
}
...
\end{tikzpicture}
\bmlDescription{World 1 is connected by an arrow to world 2. World 1
is labelled not-A. World 2 is labelled A.}
\end{center}
}
\end{compactlist}
...
\draw (2.4,-1.2) rectangle (3.6,0.5);
\end{tikzpicture}
\bmlDescription{World 1 is connected to world 2 by an arrow. Both
worlds are connected to themselves by an arrow. World 1 is labelled
not-M and not-O. World 2 is labelled M and O.}
\end{center}
}
...
\end{tikzpicture}
\bmlDescription{World 1 is connected by an arrow to world 2, and world
2 by an arrow to world 3. Each world is connected by an arrow to
itself. Worlds 1 and 2 are labelled A. World 3 is labelled not-A.}
\end{center}
}
\end{compactlist}
...
\bmlDescription{World 1 is connected to world 2 by an arrow. Both
worlds are connected to themselves by an arrow. World 1 is labelled
A and B. World 2 is labelled not-A and not-B.}
\end{center}
}
\end{compactlist}
