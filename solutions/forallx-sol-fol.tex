...
\item[] \myanswer{$\forall x (\atom{F}{x} \eif \enot \atom{G}{x}), \exists x (\atom{G}{x} \eand \atom{H}{x}) \therefore \exists x (\atom{H}{x} \eand \enot \atom{F}{x})$}
\end{compactlist}
...
\item[] \myanswer{$\exists x (\atom{P}{x} \eand \atom{L}{x,g}) \eif \atom{L}{e,g}$}
...
\begin{compactlist}
\item Toda carta de paus é preta.
