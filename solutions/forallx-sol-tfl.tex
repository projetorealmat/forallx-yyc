...
\myanswer{\begin{ekey}
\item[\ensuremath{T_1}] Chove na terça-feira
\item[\ensuremath{T_2}] Neva na terça-feira
...
\begin{compactlist}
	...
	\myanswer{\begin{ekey}
		...
		\item[\ensuremath{C_1}] Haskell gosta de observar grous (as aves)
		\item[\ensuremath{C_2}] Haskell gosta de observar grous (os equipamentos de construção)
		\end{ekey}}
