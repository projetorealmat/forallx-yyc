...
\begin{compactlist}
	...
	\myanswer{\begin{ekey}
		\item[B] Haskell is a birder
		\item[C_1] Haskell enjoys watching cranes (the bird)
		\item[C_2] Haskell enjoys watching cranes (the construction equipment)
		\end{ekey}}
	\myanswer{$B \eand C_1$\\ $B \eand C_2$}
	\item The zoo has lions or tigers and bears.
	\item[]\myanswer{\begin{ekey}
		\item[L] The zoo has lions
		\item[T] The zoo has tigers
		\item[B] The zoo has bears
		\end{ekey}}
	\myanswer{$L \eor (T \eand B)$\\ $(L \eor T) \eand B$.}
	\item The flower is not red or fragrant.
	\item[]\myanswer{\begin{ekey}
		\item[R] The flower is red
		\item[F] The flower is fragrant
		\end{ekey}}
