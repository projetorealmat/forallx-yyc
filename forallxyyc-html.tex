...
\includegraphics[width=.4\textwidth,
  alt={Capa do livro com título, autores e um grande símbolo forall vermelho sobre fundo rosa}]
...
\part*{Soluções de exercícios selecionados}
\makeatletter\renewcommand{\appendixname}{Soluções para o capítulo}\makeatother
\setcounter{chapter}{0}
\def\thechapter{\arabic{chapter}}
\input{solutions/forallx-sol-what}
\input{solutions/forallx-sol-tfl}
\input{solutions/forallx-sol-truthtables}
\input{solutions/forallx-sol-prooftfl}
\input{solutions/forallx-sol-fol}
\input{solutions/forallx-sol-interpretations}
\input{solutions/forallx-sol-prooffol}
\input{solutions/forallx-sol-ml}
\input{solutions/forallx-sol-metatheory}
\end{document}
