...
\noindent\hfil\rotatebox{-90}{% make spine text readable when book is lying cover up
      \hbox to \coverheight{\hfil
          \huge\sffamily\bfseries\color{white}
            forall \textit{x}: Uma introdução à lógica formal\hfil \forallxshortversion\hspace{2cm}}}\hfil
\end{textblock*}
\newbox\adjust
% make front cover
...
\noindent{\Huge{Remix de Calgary}}

\vspace*{1cm}
\noindent{\huge \emph{Uma introdução à lógica formal}}

\vfill
\noindent{\fontsize{16pt}{18pt}\selectfont \textbf{P.~D. Magnus}\\
  \textbf{Tim Button}\\
  \textit{com acréscimos de}\\
  \textbf{J.~Robert Loftis}\\ \textit{remixado e revisado por}\\
...
\begin{minipage}[b]{4.7cm}
  \fontsize{11pt}{1.2em}\selectfont\color{white}\textit{forall x:
    Remix de Calgary}, de P.~D. Magnus et al., é licenciado sob uma
