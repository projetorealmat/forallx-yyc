...
\usepackage{rotating}
\usepackage{xcolor}
\usepackage{forallxyyc,forallxyyc-style}
...
\setlength{\spinewidth}{438\sheetwidth}
...
\begin{textblock*}{\spinepos}(0pt,0pt)
  ...
  \begin{minipage}[b][\coverheight][b]{.85\spinepos}
    ...
    \begin{minipage}[b]{5cm}
      ...
      O \textit{forall x: Calgary}, de P.~D. Magnus et al., é
      licenciado sob uma licença Creative Commons Atribuição 4.0 Internacional.\par
      \end{raggedright}
\end{minipage}
\hfill
\vspace{1cm}

\noindent\fontsize{14pt}{16pt}\selectfont\color{white} Baixe gratuitamente em forallx.openlogicproject.org
\vspace*{2cm}
  \end{minipage}
  \hfill
\end{textblock*}
