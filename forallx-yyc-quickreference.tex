...
$P$ a menos que $Q$ & $(\enot Q \eif P )$ ou $(P \eor Q)$\\[12pt]
...
Uma maneira de dizer `há exatamente $n$ $F$s' é formar a conjunção de duas das simbolizações acima e dizer `há pelo menos $n$ $F$s e há no máximo $n$ $F$s'. As fórmulas equivalentes a seguir são mais curtas:
