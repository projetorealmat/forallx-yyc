        ...
        \newglossaryentry{satisfiability in TFL}
{
  ...
  \gls{complete truth table} de todas essas sentenças em conjunto contém uma linha
...
Neste livro, usaremos bastante a noção de implicação. Será útil, então, introduzir um símbolo que a abrevia. Em vez de dizer que as sentenças da LVF $\metav{A}_1$, $\metav{A}_2$, \dots{} e $\metav{A}_n$ em conjunto implicam $\metav{C}$, abreviaremos isso assim:
...
\end{tabular}
\end{center}
Você também sabe com certeza que uma disjunção é verdadeira sempre que um dos disjuntos é verdadeiro. Portanto, se encontrar um disjunto verdadeiro, não há necessidade de calcular o valor de verdade do outro disjunto. Assim, você poderia apresentar:
\begin{center}
...
\end{tabular}
\end{center}
Do mesmo modo, você sabe com certeza que uma conjunção é falsa sempre que um dos conjuntos é falso. Portanto, se encontrar um conjunto falso, não há necessidade de calcular o valor de verdade do outro conjunto. Assim, você poderia apresentar:
\begin{center}
\begin{tabular}{c c|d e e e e e e f}
...
Mais uma vez, começamos avaliando a conclusão. Como ela é uma disjunção, é verdadeira sempre que qualquer um dos disjuntos é verdadeiro, de modo que podemos acelerar um pouco o trabalho.
\begin{center}
...
\end{tabular}
\end{center}
Para tornar a sentença verdadeira, será suficiente garantir que o antecedente seja falso. Como o antecedente é uma conjunção, podemos simplesmente tornar um de seus conjuntos falso. Tomando uma decisão arbitrária, vamos tornar `$U$' falso; então podemos atribuir qualquer valor de verdade que quisermos às outras letras sentenciais.
\begin{center}
\begin{tabular}{c c c c|d e e e e e f}
$S$&$T$&$U$&$W$&$(U$&\eand&$T)$&\eif    &$(S$&\eand&$W)$\\
\hline
