...
Introduzimos cinco conectivos em \cref{s:TFLConnectives}. Portanto, só precisamos explicar como eles mapeiam valores de verdade. Por conveniência, abreviaremos \textquotedblleftVerdadeiro\textquotedblright{} por \textquotedblleft T\textquotedblright{} e \textquotedblleftFalso\textquotedblright{} por \textquotedblleft F\textquotedblright{}. (Mas, para deixar claro, os dois valores de verdade são Verdadeiro e Falso; os valores de verdade não são \emph{letras}!)
