...
mais de um significado. Por exemplo, \emph{banco} pode significar a
margem de um rio ou uma instituição financeira. Assim, posso dizer que
\emph{fui ao banco} quando dei um passeio ao longo do rio ou quando fui
depositar um cheque. Dependendo da situação, pretende-se um significado
diferente de \emph{banco} e, portanto, a sentença, quando proferida
...
\end{enumerate}
Há uma leitura em que \emph{voar} é usado como um adjetivo que modifica
\emph{aviões}. Nesse sentido, o que se afirma ser perigoso são aviões que
estão voando. Em outra leitura, \emph{voar} é um infinitivo: o que se
...
ela. Um adjetivo, por exemplo \emph{rico} ou \emph{alto}, é
...
casos claramente negativos (\emph{alto para uma pessoa}, \emph{alto para
um jogador de basquete}, \emph{alto para um edifício}). Mesmo quando o
...
sentenciais diferentes para \emph{Rebecca foi ao banco (financeiro)} e
\emph{Rebecca foi ao banco (do rio)}. A vagueza é mais difícil de evitar.
...
discutia que Casement havia sido \emph{aliado dos inimigos do Rei}, mas a
...
dependia de saber se \emph{ou em outro lugar} se ligava apenas a
\emph{prestar ajuda e conforto aos inimigos do Rei} (a leitura natural
sem a vírgula) ou a ambos \emph{ser aliado dos inimigos do Rei} e
\emph{prestar ajuda e conforto aos inimigos do Rei} (a leitura natural
...
\emph{enforcado por uma vírgula}.
...
de parênteses. Por exemplo, se eu disser \emph{Gosto de filmes que não
...
gosta de filmes entediantes? Mas e quanto a \emph{Gosto de pratos que não
...
melhor, por exemplo, \emph{Gosto de pratos que não são doces, mas são
saborosos}.) Ambiguidades semelhantes resultam da interação entre
\emph{e} e \emph{ou}. Por exemplo, suponha que eu peça que você me envie
...
A sentença \emph{Tai Lung é pequeno e perigoso ou furtivo} é ambígua
entre:
\begin{enumerate}
